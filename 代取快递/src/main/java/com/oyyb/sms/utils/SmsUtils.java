...
import com.oyyb.sms.config.SmsProperties;
...
public class SmsUtils {
    ...
    private static final String KRY_PREFIX = "sms:phone:";
    ...
    public SendSmsResponse sendSms(String phone,
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(prop.getVerifyCodeTemplate());
        ...
        //发送短信成功后，写入redis,指定生成时间为1分钟
        redisTemplate.opsForValue().set(key,String.valueOf(System.currentTimeMillis()),1, TimeUnit.MINUTES);
        logger.info("[短信服务],发送短信验证码,手机号:{}",phone);
